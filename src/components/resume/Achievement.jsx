...
<motion.div
      ...
      <div className="bg-gray-100 p-2 rounded-lg text-center">
        ...
        <img src="/src/assets/images/projects/Screenshot 2025-04-03 153030.png" alt="Achievement 1" className="w-full h-auto max-h-[300px] object-contain mb-4" />
      ...
      <div className="bg-gray-100 p-2 rounded-lg text-center">
        ...
        <img src="/src/assets/images/projects/Screenshot 2025-04-03 160519.png" alt="Achievement 2" className="w-full h-auto max-h-[300px] object-contain mb-4" />
      ...
      <div className="bg-gray-100 p-2 rounded-lg text-center">
        ...
        <img src="/src/assets/images/projects/download.png" alt="Achievement 3" className="w-full h-auto max-h-[300px] object-contain mb-4" />
      ...
      <div className="bg-gray-100 p-2 rounded-lg text-center">
        ...
        <img src="src/assets/images/projects/a664b4c1-4150-4d05-bfcd-de61231ccc5a.jpg" alt="Achievement 4" className="w-full h-auto max-h-[300px] object-contain mb-4" />
